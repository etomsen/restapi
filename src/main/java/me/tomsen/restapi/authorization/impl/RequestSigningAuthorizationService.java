...
import me.tomsen.restapi.util.DateUtil;
...
public class RequestSigningAuthorizationService implements AuthorizationService {
    ...
    @Autowired
    public RequestSigningAuthorizationService(UserRepository userRepository, ApplicationConfig applicationConfig) {
     ...
     */
    @Override
    public UserPrincipal authorize(AuthorizationRequestContext context) {
